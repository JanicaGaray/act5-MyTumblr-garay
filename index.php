...
$acc_username = "Janicagaray";
$acc_password = "janica12";
$acc_fullname = "Janica Ricamata Garay";
$acc_address = "Dawis PH";
...
if(isset($_REQUEST['login_button']) ===true){
  //get the username and password from the form and compare to the preefined username and password
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist']) ===true){
                        	...
                        	echo "<div class='alert alert-warning' role='alert'> You are still logge in. Please <a href='account.php'> click here </a> to proceed. </div>";
                        }
